...
describe('Persistent Node Chat Server', () => {
  ...
  it('Should output all messages from the DB', (done) => {
    // Let's insert a message into the db (might need to specify columns given auto increment)
       const queryString = 'INSERT INTO messages VALUES ("this is a test message", "Jay", "lobby");';
       // const queryArgs = [];
